...
This project is built as an architectural clone of the course's example Fire Detector project. The pipeline shape, the testing philosophy, and the security layer follow the same pattern; only the domain changes, from detecting smoke to detecting a drowsy driver.
